...
commands/join.cpp commands/privmsg.cpp commands/modechannel.cpp commands/modeuser.cpp commands/part.cpp \
commands/quit.cpp commands/topic.cpp commands/kick.cpp commands/whois.cpp commands/list.cpp
